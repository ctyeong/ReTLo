...
*t_r_x*, *t_r_y*, and *t_r_o* are the x,y-coordinates and orientation of robot *r* at 
timestep *t* where *H*, *T*, and *Fk* represent *Head*, *Tail*, and *Follower k*
where *Follower 1* is the nearest one to *Head*.
